public class Sterne {
    public static void main(String[] args) {
       ...
       /* StdDraw.line(0.0, 0.5, 0.45, 0.55);
        StdDraw.line(0.45, 0.55, 0.5, 1.0);
        StdDraw.line(0.5, 1.0, 0.55, 0.55);
        StdDraw.line(0.55, 0.55, 1.0, 0.5);
        StdDraw.line(1.0, 0.5, 0.55, 0.45);
        StdDraw.line(0.55, 0.45, 0.5, 0.0);
        StdDraw.line(0.5, 0.0, 0.45, 0.45);
        StdDraw.line(0.45, 0.45, 0.0, 0.5);
       */
    }
}
